...
namespace AdoNetTest
{
    class StartUp
    {
        private static string connectionString = "Server=DESKTOP-4Q4QNM5\\SQLEXPRESS;Database={0};Integrated Security=True;";

        static void Main(string[] args)
        {
            //DESKTOP-4Q4QNM5\SQLEXPRESS
            ...
            using (connection)
            {
                ...
                {
                    Console.WriteLine("Ther was error creating Database");
            ...
            using (connection)
            {
                ...
                {
                    Console.WriteLine("Ther was error processing your request!");
                    Console.WriteLine(e.Message);
                }
            }
        }
